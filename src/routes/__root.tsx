...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lumen — Modern Expense Manager" },
      { name: "description", content: "Track income, expenses, and budgets with beautiful dashboards and insights." },
      { property: "og:title", content: "Lumen — Modern Expense Manager" },
      { property: "og:description", content: "Track income, expenses, and budgets with beautiful dashboards and insights." },
